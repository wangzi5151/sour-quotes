...
![version](https://img.shields.io/badge/version-1.0.0-ff6b81)
...
这个 App 把「毒鸡汤」做成了每日仪式感：每天固定一句（可打卡）、随机抽取、一键复制分享，**完全离线可用、无广告、无追踪**。
...
内置 **80+ 条原创毒鸡汤**，带情绪标签（扎心 / 真相 / 哲理 / 单身 / 金钱 / 安慰），
...
- **原生插件**: Clipboard / Share / Haptics / SplashScreen / StatusBar
- **存储**: LocalStorage（收藏夹）
- **离线**: 全部资源内置，SPA 单页应用
...
│   ├── data/quotes.js       # 毒鸡汤语录库（80+ 条，可扩展）
│   └── js/
│       ├── main.js          # 应用逻辑
